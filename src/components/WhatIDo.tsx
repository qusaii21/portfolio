...
// Dark text color for SVG strokes — matches new light palette
const STROKE_COLOR = "#1A1208";
...
const WhatIDo = () => {
  ...
  return (
    <div className="whatIDO">
      <span className="whatido-doodle-squiggle" aria-hidden="true">〰</span>
      <span className="whatido-doodle-dot" aria-hidden="true">●</span>
      <div className="whatido-blob" aria-hidden="true"></div>
      <span className="whatido-bg-text" aria-hidden="true">SKILLS.</span>
